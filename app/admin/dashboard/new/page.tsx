...
import { Header, Footer, RegionSelector } from '@/components';
            ...
            <main className="flex-1">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-primary">새 가게 추가</h1>
                    </div>
                        ...
                        <div className="bg-card rounded-xl border border-border p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-background border border-border rounded-xl text-primary"
                                    placeholder="예: 11:00 - 22:00 (월요일 휴무)"
                                />
                            </div>
